...
@genType
and entities = {
    @as("Contribution") contribution: entityStoreOperations<Entities.Contribution.t>,
    @as("Contributor") contributor: entityStoreOperations<Entities.Contributor.t>,
    @as("PayrollFunding") payrollFunding: entityStoreOperations<Entities.PayrollFunding.t>,
    @as("Project") project: entityStoreOperations<Entities.Project.t>,
    @as("SystemStat") systemStat: entityStoreOperations<Entities.SystemStat.t>,
    @as("UnitConversion") unitConversion: entityStoreOperations<Entities.UnitConversion.t>,
    @as("UnitDistribution") unitDistribution: entityStoreOperations<Entities.UnitDistribution.t>,
  }
  ...
  let entities = {
      contribution: {
        makeStoreOperatorEntity(
          ...
          ~getStore=db => db->InMemoryStore.getInMemTable(
            ~entityConfig=module(Entities.Contribution)->Entities.entityModToInternal,
          )->(
            Utils.magic: InMemoryTable.Entity.t<Internal.entity> => InMemoryTable.Entity.t<
              Entities.Contribution.t,
            >
          ),
          ~getKey=({id}) => id,
        )
      ...
      contributor: {
        makeStoreOperatorEntity(
          ...
          ~makeMockDb=makeWithInMemoryStore,
          ~getStore=db => db->InMemoryStore.getInMemTable(
            ~entityConfig=module(Entities.Contributor)->Entities.entityModToInternal,
          )->(
            Utils.magic: InMemoryTable.Entity.t<Internal.entity> => InMemoryTable.Entity.t<
              Entities.Contributor.t,
            >
          ),
          ~getKey=({id}) => id,
        )
      ...
      payrollFunding: {
        makeStoreOperatorEntity(
          ...
          ~makeMockDb=makeWithInMemoryStore,
          ~getStore=db => db->InMemoryStore.getInMemTable(
            ~entityConfig=module(Entities.PayrollFunding)->Entities.entityModToInternal,
          )->(
            Utils.magic: InMemoryTable.Entity.t<Internal.entity> => InMemoryTable.Entity.t<
              Entities.PayrollFunding.t,
            >
          ),
          ~getKey=({id}) => id,
        )
      ...
      project: {
        makeStoreOperatorEntity(
          ...
          ~makeMockDb=makeWithInMemoryStore,
          ~getStore=db => db->InMemoryStore.getInMemTable(
            ~entityConfig=module(Entities.Project)->Entities.entityModToInternal,
          )->(
            Utils.magic: InMemoryTable.Entity.t<Internal.entity> => InMemoryTable.Entity.t<
              Entities.Project.t,
            >
      ...
      systemStat: {
        makeStoreOperatorEntity(
          ...
          ~makeMockDb=makeWithInMemoryStore,
          ~getStore=db => db->InMemoryStore.getInMemTable(
            ~entityConfig=module(Entities.SystemStat)->Entities.entityModToInternal,
          )->(
            Utils.magic: InMemoryTable.Entity.t<Internal.entity> => InMemoryTable.Entity.t<
              Entities.SystemStat.t,
            >
          ),
          ~getKey=({id}) => id,
        )
      ...
      unitConversion: {
        makeStoreOperatorEntity(
          ...
          ~makeMockDb=makeWithInMemoryStore,
          ~getStore=db => db->InMemoryStore.getInMemTable(
            ~entityConfig=module(Entities.UnitConversion)->Entities.entityModToInternal,
          )->(
            Utils.magic: InMemoryTable.Entity.t<Internal.entity> => InMemoryTable.Entity.t<
              Entities.UnitConversion.t,
            >
          ),
          ~getKey=({id}) => id,
        )
      ...
      unitDistribution: {
        makeStoreOperatorEntity(
          ...
          ~makeMockDb=makeWithInMemoryStore,
          ~getStore=db => db->InMemoryStore.getInMemTable(
            ~entityConfig=module(Entities.UnitDistribution)->Entities.entityModToInternal,
          )->(
            Utils.magic: InMemoryTable.Entity.t<Internal.entity> => InMemoryTable.Entity.t<
              Entities.UnitDistribution.t,
            >
          ),
          ~getKey=({id}) => id,
        )
...
and makeProcessEvents = (mockDb: t, ~chainId=?) => async (
  ...
  try {
    await eventItems->EventProcessing.runBatchLoadersOrThrow(
      ~loadManager,
      ~persistence,
      ~inMemoryStore,
    )
